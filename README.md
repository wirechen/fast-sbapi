...
2. 该项目可能我不会再更新了，因为它单纯作为一个自动生成API脚手架项目的话这里有一个更智能的替代品，那就是Spring推出的更好更快更“傻瓜”的API脚手架项目：Spring Data Rest。它可以让我们通过定义Model自动生成Restful风格的API，感兴趣的朋友可以去官方[看一看](https://projects.spring.io/spring-data-rest)。  
